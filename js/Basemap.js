      ...
      resize: function() {
        //this._responsive();
         if (window.innerWidth > 1200) {
                ...
                domStyle.set(registry.byId("basemapDialog").containerNode, "height", "150px");
                ...
                domStyle.set(dom.byId("basemapDialog"), "height", "170px");
                domStyle.set(registry.byId("basemapDialog").containerNode, "height", "120px");
                 domStyle.set("basemapDialog", "left", "auto");
                    domStyle.set("basemapDialog","right","20px");
                    domStyle.set("basemapDialog", "top", "210px");
                ...
                domStyle.set(registry.byId("basemapDialog").containerNode, "height", "100px");
                 domStyle.set("basemapDialog", "left", "auto");
                    domStyle.set("basemapDialog","right","20px");
                ...
                domStyle.set(registry.byId("basemapDialog").containerNode, "height", "70px");
                ...
                domStyle.set(registry.byId("basemapDialog").containerNode, "height", "50px");
                 domStyle.set("basemapDialog", "left", "auto");
                    domStyle.set("basemapDialog","right","20px");
                ...
                domStyle.set(registry.byId("basemapDialog").containerNode, "height", "40px");
                 domStyle.set("basemapDialog", "left", "auto");
                    domStyle.set("basemapDialog","right","20px");
                    domStyle.set("basemapDialog", "top", "204px");
            }
