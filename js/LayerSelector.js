...
define([
    ...
    "dijit/TooltipDialog"
        ...
        function (
                ...
                domStyle, Tooltip,
                PopupTemplate) {
            return declare("application.LayerSelector", [Evented], {
                ...
                resultLayerList: [],
                postCreate: function () {
                    domConstruct.place('<img id="loadingIsLayers" style="position: absolute;top:0;bottom: 0;left: 0;right: 0;margin:auto;z-index:100;" src="images/loading.gif">', "layerSelectorNode");
                    this.hideLoading();
                ...
                setTooltips: function () {
                    new Tooltip({
                        connectId: ['saveIconBtn'],
                        position: ['below'],
                        label: this.i18n.resultSave
                    });

                    new Tooltip({
                        connectId: ['primaryShow'],
                        position: ['below'],
                        label: this.i18n.active
                    });
                    new Tooltip({
                        connectId: ['secondaryBtn'],
                        position: ['below'],
                        label: this.i18n.copy
                    });
                    new Tooltip({
                        connectId: ['secondaryShow'],
                        position: ['below'],
                        label: this.i18n.comparison
                    });
                    new Tooltip({
                        connectId: ['toggleLayers'],
                        position: ['below'],
                        label: this.i18n.swap
                    });
                },
                ...
                populateServices: function () {
                    ...
                    if (this.itemInfo) {
                        mainLayers = this.itemInfo.itemData.operationalLayers;
                        this.layerList1 = [];
