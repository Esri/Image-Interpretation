        ...
        function (
            ...
            return declare("application.ChangeDetection", [Evented], {
                constructor: function (parameters) {
                    var defaults = {
                        map: null,
                        changeModes: {difference: true, veg: false, savi: false, water: false, burn: false},
                        i18n: null
                    };
                ...
                refreshData: function () {
                    if (this.map.layerIds) {
                        if (this.map.primaryLayer && this.map.getLayer(this.map.primaryLayer).serviceDataType && this.map.getLayer(this.map.primaryLayer).serviceDataType.substr(0, 16) === "esriImageService") {
                            ...
                            if (this.map.secondaryLayer && this.map.getLayer(this.map.secondaryLayer).serviceDataType && this.map.getLayer(this.map.secondaryLayer).serviceDataType.substr(0, 16) === "esriImageService")
                        ...
                        if (this.secondaryLayer && this.primaryLayer && this.secondaryLayer.url === this.primaryLayer.url) {
                            if ((this.primaryLayer.mosaicRule !== null) && (this.primaryLayer.mosaicRule.lockRasterIds !== null) && (this.secondaryLayer.mosaicRule !== null) && (this.secondaryLayer.mosaicRule.lockRasterIds !== null)) {
                                ...
                                html.set(document.getElementById("setPrimarySecondaryLayers"), "");
                                this.prevPrimaryLayer = this.primaryLayer.url;
                            } else {
                                domStyle.set("changeDetectionDisplay", "display", "none");

                                html.set(document.getElementById("setPrimarySecondaryLayers"), this.i18n.error);
                            }
                        } else {
                            domStyle.set("changeDetectionDisplay", "display", "none");
                            html.set(document.getElementById("setPrimarySecondaryLayers"), this.i18n.error);
                ...
                detectChange: function () {
                    ...
                    if (method === "difference") {
                        ...
                        if (changeMode === "image") {
                            ...
                            if (positiveRange[1] === 1)
                                positiveRange[1] = 5;
                            if (negativeRange[0] === -1)
                                negativeRange[0] = -5;
